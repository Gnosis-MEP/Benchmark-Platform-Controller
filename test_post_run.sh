...
wget -T 10 -O- --post-data='{"override_services": {"query-manager": {"image": "registry.insight-centre.org/sit/mps/query-manager:latest"} }}' --header='Content-Type:application/json' 'http://localhost:5000/api/v1.0/run_benchmark'
